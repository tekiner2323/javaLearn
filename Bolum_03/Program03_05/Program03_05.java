...
class Araba
{
	...
	protected String tip; //Sedan, Hatcback, SUV, 4x4
	
	protected double motorHacmi;
	protected int motorGucu;
	protected int motorTorku;
...
{
	// fonksiyonlar ve değişlenler default eşirimde bırakıldıkları için önce onları güncellemek gerekir. bu yüzden alt sınıfların erişebilmesi için protected ön erişim eki getirecem.
	
	private String motorNo;
	Kamyon(String marka, String model, String tip, String motorNo)
	{
		this.marka=marka;
		this.model=model;
		this.tip = tip;
...
public class Program03_05
{
	...
	public static void main (String[] args)
	{
		...
		Kamyon Kornek = new Kamyon("Volvo", "Sleeper", "Çekici", "99ABC998877");
		
		System.out.println("Kamyon Marka= " + Kornek.marka);
		System.out.println("kamyon motor numarası = " + Kornek.getMotorNo());
	}
}
